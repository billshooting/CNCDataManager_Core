...
angular.module('cncdataManagerApp')
  .directive('spindleBeltSizes', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/SpindleBeltSizes.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'spindlebeltsizes/';
              ...
              scope.colState = [true, true];  //控制是否显示
