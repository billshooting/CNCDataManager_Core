...
angular.module('cncdataManagerApp')
  .directive('ballLeadScrewSptBrgs', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/BallLeadScrewSptBrgs.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'ballleadscrewsptbrgs/';
