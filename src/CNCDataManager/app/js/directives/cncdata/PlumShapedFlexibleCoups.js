...
angular.module('cncdataManagerApp')
  .directive('plumShapedFlexibleCoupling', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/PlumShapedFlexibleCoups.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'plumshapedflexiblecoups/';
