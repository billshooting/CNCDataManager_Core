...
angular.module('cncdataManagerApp').directive('arcCylinWormGears', 
    function(TableHandler, $modal)
    {
        return {
            templateUrl: '../App/views/templates/ArcCylinWormGears.html',
            restrict: 'E',
            scope: true,
            link: function postLink(scope)
            {
                scope.ITEMNAME = 'arccylinwormgears/';
                ...
                scope.colState = [true, true, false, false, false, false, false];  //控制是否显示
