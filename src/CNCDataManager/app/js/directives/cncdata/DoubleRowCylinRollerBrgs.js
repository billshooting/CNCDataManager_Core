...
angular.module('cncdataManagerApp')
  .directive('doubleRowCylinRollerBrgs', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/DoubleRowCylinRollerBrgs.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'doublerowcylinrollerbrgs/';
