...
angular.module('cncdataManagerApp')
  .directive('straightBevelGears', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/StraightBevelGears.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'straightbevelgears/';
              ...
              scope.colState = [false, true, false, false, false, false, false];  //控制是否显示
