...
angular.module('cncdataManagerApp')
  .directive('rotaryTables', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/RotaryTables.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'rotarytables/';
              ...
              scope.colState = [true, true, false, false];  //控制是否显示
