...
angular.module('cncdataManagerApp')
  .directive('needleRollerThrustRollerBrgs', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/needleRollerThrustRollerBrgs.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'needlerollerthrustrollerbrgs/';
