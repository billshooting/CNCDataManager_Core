...
angular.module('cncdataManagerApp')
  .directive('srvDriverBrakeResistors', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/SrvDriverBrakeResistors.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'srvdriverbrakeresistors/';
