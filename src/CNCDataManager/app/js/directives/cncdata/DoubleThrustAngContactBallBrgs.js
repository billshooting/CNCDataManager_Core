...
angular.module('cncdataManagerApp')
  .directive('doubleThrustAngContactBallBrgs', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/DoubleThrustAngContactBallBrgs.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'doublethrustangcontactballbrgs/';
