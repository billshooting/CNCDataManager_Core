...
angular.module('cncdataManagerApp')
  .directive('spindleSrvMotorDrivers', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/SpindleSrvMotorDrivers.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'spindlesrvmotordrivers/';
              ...
              scope.colState = [true, false, false, false];  //控制是否显示
