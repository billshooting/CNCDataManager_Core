...
angular.module('cncdataManagerApp')
  .directive('spindleBeltParas', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/SpindleBeltParas.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'spindlebeltparas/';
              ...
              scope.colState = [true, true, false, true];  //控制是否显示
