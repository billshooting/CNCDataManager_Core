...
angular.module('cncdataManagerApp')
  .directive('ncFunctionalOptions', function (TableHandler, $modal) {
      return {
          templateUrl: '../App/views/templates/NCSystemFunctionalOptions.html',
          restrict: 'E',
          scope: true,
          link: function postLink(scope) {
              // 0. 辅助方法声明
              scope.ITEMNAME = 'ncsystemfunctionaloptions/';
