...
export class BWElasticSleevePinCouplings {
    ...
    public constructor($modal: mgcrea.ngStrap.modal.IModalService, tableHandler: TableHandler, $scope: ICncDataScope)
    {
        ...
        // 0. 辅助方法声明
        $scope.ITEMNAME = 'bwelasticslvpincoups/';
        ...
        // 2. 添加表格显示方法
        let handler: ITableHandler = tableHandler.buildTableHandler($scope);
...
BWElasticSleevePinCouplings.$inject = ['$modal', 'TableHandler', '$scope'];