...
export class SolidBallScrewNutPairs {
    ...
    public constructor(tableHandler: TableHandler, $scope: ICncDataScope) 
    {
        ...
        $scope.colState = [false, false, false, false, false, false, false];  //控制是否显示
...
SolidBallScrewNutPairs.$inject = ['$modal', 'TableHandler', '$scope'];