...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class SpindleSrvMotorDriversController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSpindleSrvMotorDriver(string id, [FromBody] SpindleSrvMotorDriver spindleSrvMotorDriver)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostSpindleSrvMotorDriver([FromBody]SpindleSrvMotorDriver spindleSrvMotorDriver)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
