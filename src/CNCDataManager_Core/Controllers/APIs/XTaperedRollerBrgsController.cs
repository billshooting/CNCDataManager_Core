...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class XTaperedRollerBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutXTaperedRollerBrg(string id, XTaperedRollerBrg xTaperedRollerBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostXTaperedRollerBrg(XTaperedRollerBrg xTaperedRollerBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
