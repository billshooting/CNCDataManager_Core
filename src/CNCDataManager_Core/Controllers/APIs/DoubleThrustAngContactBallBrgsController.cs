...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class DoubleThrustAngContactBallBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDoubleThrustAngContactBallBrg(string id, DoubleThrustAngContactBallBrg doubleThrustAngContactBallBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostDoubleThrustAngContactBallBrg(DoubleThrustAngContactBallBrg doubleThrustAngContactBallBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
