...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class AlignRollerBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutAlignRollerBrg(string id, AlignRollerBrg alignRollerBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostAlignRollerBrg(AlignRollerBrg alignRollerBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
