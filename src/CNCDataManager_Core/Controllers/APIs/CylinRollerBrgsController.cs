...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class CylinRollerBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutCylinRollerBrg(string id, CylinRollerBrg cylinRollerBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostCylinRollerBrg(CylinRollerBrg cylinRollerBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
