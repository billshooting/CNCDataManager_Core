...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class FlexiblePinCoupsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutFlexiblePinCoup(string id, FlexiblePinCoup flexiblePinCoup)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostFlexiblePinCoup(FlexiblePinCoup flexiblePinCoup)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
