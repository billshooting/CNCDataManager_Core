...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class DeepGrooveBallBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutDeepGrooveBallBrg(string id, DeepGrooveBallBrg deepGrooveBallBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostDeepGrooveBallBrg(DeepGrooveBallBrg deepGrooveBallBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
