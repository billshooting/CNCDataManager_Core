...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class PlumShapedFlexibleCoupsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutPlumShapedFlexibleCoup(string id, PlumShapedFlexibleCoup plumShapedFlexibleCoup)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostPlumShapedFlexibleCoup(PlumShapedFlexibleCoup plumShapedFlexibleCoup)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
