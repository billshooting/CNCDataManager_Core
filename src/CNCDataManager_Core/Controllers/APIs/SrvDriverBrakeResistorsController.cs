...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class SrvDriverBrakeResistorsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSrvDriverBrakeResistor(string id, SrvDriverBrakeResistor srvDriverBrakeResistor)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostSrvDriverBrakeResistor(SrvDriverBrakeResistor srvDriverBrakeResistor)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
