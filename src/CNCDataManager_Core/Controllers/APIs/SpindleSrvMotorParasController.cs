...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class SpindleSrvMotorParasController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutSpindleSrvMotorPara(string id, SpindleSrvMotorPara spindleSrvMotorPara)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostSpindleSrvMotorPara(SpindleSrvMotorPara spindleSrvMotorPara)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
