...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class NeedleRollerThrustRollerBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutNeedleRollerThrustRollerBrg(string id, NeedleRollerThrustRollerBrg needleRollerThrustRollerBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostNeedleRollerThrustRollerBrg(NeedleRollerThrustRollerBrg needleRollerThrustRollerBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
