...
namespace CNCDataManager.Controllers.APIs
{
    ...
    public class TaperedRollerBrgsController : Controller
    {
        ...
        [HttpPut("{id}")]
        public async Task<IActionResult> PutTaperedRollerBrg(string id, TaperedRollerBrg taperedRollerBrg)
        {
        ...
        [HttpPost]
        public async Task<IActionResult> PostTaperedRollerBrg(TaperedRollerBrg taperedRollerBrg)
        {
            if (!ModelState.IsValid)
            {
                return BadRequest(ModelState);
